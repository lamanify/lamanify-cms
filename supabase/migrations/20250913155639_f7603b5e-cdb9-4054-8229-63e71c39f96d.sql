...
-- This allows staff to see doctor profiles needed for appointments and queue management
CREATE POLICY "Staff can view doctor profiles" 
ON public.profiles 
FOR SELECT 
USING (
  -- Allow viewing doctor/admin profiles for legitimate business purposes
