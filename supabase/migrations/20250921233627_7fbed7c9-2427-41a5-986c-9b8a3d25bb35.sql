...
-- Add cost tracking fields to stock_movements table
...
DECLARE
  ...
  current_avg_cost NUMERIC;
BEGIN
  -- Only calculate for stock increases (purchases, adjustments up)
  IF NEW.movement_type IN ('purchase', 'adjustment') AND NEW.quantity > 0 THEN
